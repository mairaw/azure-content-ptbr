...
A página [Comparação de Aplicativos Web, Serviços de Nuvem e Máquinas Virtuais do Azure](choose-web-site-cloud-service-vm.md) fornece informações mais detalhadas sobre como escolher um modelo de computação.
